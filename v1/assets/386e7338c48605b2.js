  ...
  !(function () {
    ...
    const themeSwitch = () => {
      ...
      const setTheme = () => {
        ...
        // Если темы нет, header.php уже установил её по времени и сохранил
        // Не устанавливаем 'light' по умолчанию, чтобы не перезаписывать авто-определение
        if (currentTheme === 'light' || currentTheme === 'dark') {
          document.documentElement.dataset.theme = currentTheme;
        }
        // Если темы нет - header.php уже обработал это
      };
      ...
      if (themeBtn && !themeBtn.classList.contains("js-theme-toggle")) {
...
*/
    ...
    const creditCalc = (input) => {
      ...
      ).value; // Тип платежей (Аннуитетный/Дифференцированный)
    ...
    setTimeout(() => {
      ...
      cashbackSum = document.getElementById("calc__cashbackSum"); // Суммарный Кешбэк в рублях
    }, 200);
    ...
    const multipleSelect = (selector) => {
      ...
      select.forEach((item) => {
        ...
        const counter = btn ? btn.querySelector(`${selector}__btn-count`) : null;
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      setTimeout(() => {
        // Select
        if (document.querySelector(".styledSelect")) {
          components_select(".styledSelect");
        }

        // Range input slider
        if (document.querySelector(".range__input")) {
          range(".range__input");
        }

        // Slide down modal like search & region
        if (document.querySelector(".btn__modal-show")) {
        ...
        // Show all comments
        if (document.getElementById("show__comments")) {
          components_showAllComments();
        }

        // Mobile compare pagination
        if (
          document.getElementById("compare__fixed") ||
          document.querySelector(".compare__row")
        ) {
          components_comparePagination();
        }

        // Show more button
        if (document.querySelector(".btn__view-all")) {
        ...
        // Show hidden table
        if (document.querySelector(".btn__details")) {
          components_btnShow(".btn__details", "tr__hidden");
        }

        // Page navigation
        if (document.querySelector(".btn-pageNav")) {
        ...
        if (document.getElementById("btnScrollUp")) {
